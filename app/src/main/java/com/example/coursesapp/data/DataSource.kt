...
object DataSource {
    ...
    val topics = listOf(
        ...
        Topic(R.string.engineering, 67, R.drawable.ecology),
        Topic(R.string.fashion, 67, R.drawable.fashion),
        Topic(R.string.fianance, 100, R.drawable.finance),
        ...
        Topic(R.string.music, 112, R.drawable.music),
